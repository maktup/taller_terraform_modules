...
variable "const_lista_datos_instancia" {
  description = "Lista de datos para INSTANCIAS - EC2."
  type = "list"
  default = [
    {
      posicion = "0",
